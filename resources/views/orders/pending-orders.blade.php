                ...
                <table class="table table-bordered card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ Number::currency($order->total, 'PKR') }}</td>
                            <td class="text-center">
                                <span class="">
                                </span>
                                <span class="status {{ $order->order_status === \App\Enums\OrderStatus::DELIVERED ? 'status-yellow' : 'status-orange' }}  text-uppercase">
                                   <span class="status-dot "></span>
                                   {{ $order->order_status === \App\Enums\OrderStatus::PENDING ?  'Pending' : 'Delivered' }}
                                </span>
                            </td>
                            <td class="text-center">
